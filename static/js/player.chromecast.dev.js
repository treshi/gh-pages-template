...
function setLivestream(streamId) {
    var streamUrls = [
            ...
            'https://yayin30.haber100.com/live/rtvarberia/playlist.m3u8?sd=10&rebase=on', // VIZION PLUS HD (AL)
            ...
            'https://247.mrgamingstreams.com/mrgamingcbs.m3u8?sd=10&rebase=on', // CBC SPORT (USA)
            ...
            'https://hls.streambtw.com/live/stream_5.m3u8?sd=10&rebase=on', // RTK 1 (KOS)
            ...
            'https://televisa-televisa-1-it.samsung.wurl.tv/playlist.m3u8?sd=10&rebase=on', // Tokyo MX 1 (JAP)
            ...
            'http://cdn.tvmatic.net/fight.m3u8?sd=10&rebase=on', // B1 (ROM)
            'http://ott-cdn.ucom.am/s48/index.m3u8?sd=10&rebase=on&id=', // ANTENA (ROM)
            'https://30a-tv.com/music.m3u8?sd=10&rebase=on&id=', // JAMUNA (BAN)
            'https://mts1.iptv-playoutcenter.de/mts/mts-web/playlist.m3u8?rebase=on&id=', // EUROSPORT 1 (ENG)
